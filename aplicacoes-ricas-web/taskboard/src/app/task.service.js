...
var TaskService = (function () {
    function TaskService(http) {
        this.http = http;
        this.apiLivros = 'http://localhost:3004/estorias';
        this.apiLivro = 'http://localhost:3004/estorias/';
    }
    ...
    TaskService.prototype.getLivros = function () {
    ...
    TaskService.prototype.extrairDados = function (res) {
        var body = res.json();
        return body || {};
    };
