package br.com.trabalhocursoweb.dao;

import java.util.ArrayList;
import java.util.List;

import br.com.trabalhocursoweb.model.BaseModel;
...
public abstract class SimpleDaoGenerico<T extends BaseModel> {
	 ...
	 * 
	 * @param entidadeEntidade a ser persistida.
	 */
	 ...
	 * 
	 * @param entidade entidade a ser excluida
	 */
	protected void excluir(T entidade) {
