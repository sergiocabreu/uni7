package br.com.trabalhocursoweb.util;
...
/**
 * Classe para auxiliar nas validacoes.
 */
public class ValidacaoHelper {
	...
	public static boolean validaCep(Cep cep) {
		
		if (cep != null) {
		
            try {
                // Testa se somente existem numeros.
                Long.valueOf(cep.getRegiao());
                Long.valueOf(cep.getSufixo());
